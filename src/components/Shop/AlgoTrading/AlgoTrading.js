...
export default function AlgoTrading(props) {
    ...
    const titles = [
        { id: 1, title: 'Starter 1' },
        { id: 2, title: 'Starter 2' },
        { id: 3, title: 'Starter 3' },
    ]
                        ...
                        <div>
                            ...
                            <div className="d-flex flex-wrap justify-content-around">
                                <div style={{ height: 'max-content' }} className="mt-3 mt-md-5">
                                    {
                                        titles.map((item, i) => {
                                            return (
                                                <div key={i} className='border mt-3 rounded-4 py-3 bg-black border-warning border-2'>
                                                    <div className="container">
                                                        <div className='row'>
                                                            <div className='col-12 col-md-4 text-center'>
                                                                <img onMouseOver={handleMouseOver} onMouseEnter={() => setItemTitle(item.title)} onMouseLeave={()=>setItemTitle('')} onMouseOut={handleMouseOut} style={{ cursor: 'pointer' }} className='img-fluid h-100' src={require('../../../assets/images/Shop/card-img.png')} alt="" />
                                                            </div>
                                                            <div className='px-4 py-2 col-12 col-md-8'>
                                                                <div className="d-flex flex-wrap">
                                                                    <Link onMouseOver={handleMouseOver} onMouseEnter={() => setItemTitle(item.title)} onMouseLeave={()=>setItemTitle('')} onMouseOut={handleMouseOut} className='h4 text-warning card_title m-0'>{item.title}</Link>
                                ...
                                <div className={isHovering ? 'visible algoHide' : 'invisible algoHide'}>
                                    <p className='text-light my-3 my-md-2 fs-3'>{itemTitle}</p>
