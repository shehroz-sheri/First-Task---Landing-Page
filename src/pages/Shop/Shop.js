...
import AlgoTrading from '../../components/Shop/AlgoTrading/AlgoTrading'
import CEX from '../../components/Shop/CEX/CEX'
...
export default function Shop() {
    return (
        <>
            ...
            <AlgoTrading title='The Algo-Trading Full Service' />
            <AlgoTrading title='The Copy Trading Service' />
            <CEX />
        </>
    )
}
